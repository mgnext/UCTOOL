 ...
 *         &lt;element name="autoNetworkDetection" type="{http://www.cisco.com/AXL/API/10.5}boolean" minOccurs="0"/>
 *         &lt;element name="mtu" type="{http://www.cisco.com/AXL/API/10.5}XInteger" minOccurs="0"/>
 *         &lt;element name="failToConnect" type="{http://www.cisco.com/AXL/API/10.5}XInteger" minOccurs="0"/>
 *         &lt;element name="clientAuthentication" type="{http://www.cisco.com/AXL/API/10.5}XVPNClientAuthentication" minOccurs="0"/>
 *         &lt;element name="pwdPersistant" type="{http://www.cisco.com/AXL/API/10.5}boolean" minOccurs="0"/>
 *         &lt;element name="enableHostIdCheck" type="{http://www.cisco.com/AXL/API/10.5}boolean" minOccurs="0"/>
 *       &lt;/sequence>
