 ...
 *         &lt;element name="routeGroupName" type="{http://www.cisco.com/AXL/API/10.5}XFkType"/>
 *         &lt;element name="selectionOrder" type="{http://www.cisco.com/AXL/API/10.5}XInteger"/>
 *         &lt;element name="calledPartyTransformationMask" type="{http://www.cisco.com/AXL/API/10.5}String50" minOccurs="0"/>
 *         &lt;element name="callingPartyTransformationMask" type="{http://www.cisco.com/AXL/API/10.5}String50" minOccurs="0"/>
 ...
 *         &lt;element name="prefixDigitsOut" type="{http://www.cisco.com/AXL/API/10.5}String50" minOccurs="0"/>
 *         &lt;element name="useFullyQualifiedCallingPartyNumber" type="{http://www.cisco.com/AXL/API/10.5}XStatus"/>
